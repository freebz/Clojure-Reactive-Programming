...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq27687){
...
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27688,G__27689,seq27687__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__27693_SHARP_){
return !((cljs.core.meta.call(null,p1__27693_SHARP_) == null));
})))){
...
var map__27694 = opts;
var map__27694__$1 = ((((!((map__27694 == null)))?(((((map__27694.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__27694.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__27694):map__27694);
var markup_db = cljs.core.get.call(null,map__27694__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e27698){var _e__26678__auto__ = e27698;
return false;
}})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
}catch (e27700){var _e__26678__auto__ = e27700;
return false;
}}
})())){
...
var _STAR_current_state_STAR_27702 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__27703 = opts;
...
var markup_db = cljs.core.get.call(null,map__27703__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_27702;
}});
...
;
var temp__5455__auto___27707 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___27707)){
var managed_print_level_27708 = temp__5455__auto___27707;
var _STAR_print_level_STAR_27706_27709 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_27708;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_27706_27709,managed_print_level_27708,temp__5455__auto___27707,writer,opts,job_fn){
return (function (p1__27705_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__27705_SHARP_,null);
});})(_STAR_print_level_STAR_27706_27709,managed_print_level_27708,temp__5455__auto___27707,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_27706_27709;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1672617808861
