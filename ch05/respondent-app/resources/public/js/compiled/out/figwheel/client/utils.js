...
return (new CustomEvent(event_name,(function (){var obj30041 = {"detail":data};
return obj30041;
})()));
} else {
...
var f = (function (){var pred__30048 = cljs.core._EQ_;
var expr__30049 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__30048.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__30049))){
return ((function (pred__30048,expr__30049){
return (function (p1__30042_SHARP_){
return console.warn(p1__30042_SHARP_);
});
;})(pred__30048,expr__30049))
} else {
if(cljs.core.truth_(pred__30048.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__30049))){
return ((function (pred__30048,expr__30049){
return (function (p1__30043_SHARP_){
return console.debug(p1__30043_SHARP_);
});
;})(pred__30048,expr__30049))
} else {
if(cljs.core.truth_(pred__30048.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__30049))){
return ((function (pred__30048,expr__30049){
return (function (p1__30044_SHARP_){
return console.error(p1__30044_SHARP_);
});
;})(pred__30048,expr__30049))
} else {
return ((function (pred__30048,expr__30049){
return (function (p1__30045_SHARP_){
return console.log(p1__30045_SHARP_);
});
;})(pred__30048,expr__30049))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__30052){
...
var opts = map__30053__$1;
var eval_fn = cljs.core.get.call(null,map__30053__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__30055_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__30057,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1672617817301
