...
var i_11560 = (0);
while(true){
if((i_11560 < arr.length)){
(arr[i_11560] = null);

var G__11561 = (i_11560 + (1));
i_11560 = G__11561;
continue;
} else {
}
...
var i_11568 = (self__.level + (1));
while(true){
if((i_11568 <= (new_level + (1)))){
(update[i_11568] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_11570 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_11570[i]));
} else {
x__$2.forward.push((((i < links_11570.length))?(links_11570[i]):null));
}

if((i < links_11570.length)){
(links_11570[i] = x__$2);
} else {
links_11570.push(x__$2);
}
...
var i_11572 = (0);
while(true){
if((i_11572 <= self__.level)){
var links_11573 = (update[i_11572]).forward;
if((x__$1 === (((i_11572 < links_11573.length))?(links_11573[i_11572]):null))){
(links_11573[i_11572] = (x__$1.forward[i_11572]));

var G__11574 = (i_11572 + (1));
i_11572 = G__11574;
continue;
} else {
var G__11575 = (i_11572 + (1));
i_11572 = G__11575;
continue;
}
} else {
...
var G__11577 = nx;
var G__11578 = (level__$1 - (1));
x = G__11577;
level__$1 = G__11578;
continue;
} else {
var G__11579 = x;
var G__11580 = (level__$1 - (1));
x = G__11579;
level__$1 = G__11580;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__11582 = nx;
var G__11583 = (level__$1 - (1));
x = G__11582;
level__$1 = G__11583;
continue;
} else {
var G__11584 = x;
var G__11585 = (level__$1 - (1));
x = G__11584;
level__$1 = G__11585;
continue;
}
