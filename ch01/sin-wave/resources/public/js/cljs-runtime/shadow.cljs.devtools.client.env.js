...
shadow.cljs.devtools.client.env.add_warnings_to_info = (function shadow$cljs$devtools$client$env$add_warnings_to_info(p__10963){
var map__10964 = p__10963;
var map__10964__$1 = cljs.core.__destructure_map(map__10964);
var msg = map__10964__$1;
var info = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10964__$1,new cljs.core.Keyword(null,"info","info",-317069002));
var warnings = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.distinct.cljs$core$IFn$_invoke$arity$1((function (){var iter__5523__auto__ = (function shadow$cljs$devtools$client$env$add_warnings_to_info_$_iter__10966(s__10967){
return (new cljs.core.LazySeq(null,(function (){
var s__10967__$1 = s__10967;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__10967__$1);
if(temp__5804__auto__){
var xs__6360__auto__ = temp__5804__auto__;
var map__10972 = cljs.core.first(xs__6360__auto__);
var map__10972__$1 = cljs.core.__destructure_map(map__10972);
var src = map__10972__$1;
var resource_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10972__$1,new cljs.core.Keyword(null,"resource-name","resource-name",2001617100));
var warnings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10972__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
if(cljs.core.not(new cljs.core.Keyword(null,"from-jar","from-jar",1050932827).cljs$core$IFn$_invoke$arity$1(src))){
var iterys__5519__auto__ = ((function (s__10967__$1,map__10972,map__10972__$1,src,resource_name,warnings,xs__6360__auto__,temp__5804__auto__,map__10964,map__10964__$1,msg,info){
return (function shadow$cljs$devtools$client$env$add_warnings_to_info_$_iter__10966_$_iter__10968(s__10969){
return (new cljs.core.LazySeq(null,((function (s__10967__$1,map__10972,map__10972__$1,src,resource_name,warnings,xs__6360__auto__,temp__5804__auto__,map__10964,map__10964__$1,msg,info){
return (function (){
var s__10969__$1 = s__10969;
while(true){
var temp__5804__auto____$1 = cljs.core.seq(s__10969__$1);
if(temp__5804__auto____$1){
var s__10969__$2 = temp__5804__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__10969__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__10969__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__10971 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__10970 = (0);
while(true){
if((i__10970 < size__5522__auto__)){
var warning = cljs.core._nth(c__5521__auto__,i__10970);
cljs.core.chunk_append(b__10971,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(warning,new cljs.core.Keyword(null,"resource-name","resource-name",2001617100),resource_name));

var G__11032 = (i__10970 + (1));
i__10970 = G__11032;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__10971),shadow$cljs$devtools$client$env$add_warnings_to_info_$_iter__10966_$_iter__10968(cljs.core.chunk_rest(s__10969__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__10971),null);
}
} else {
var warning = cljs.core.first(s__10969__$2);
return cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(warning,new cljs.core.Keyword(null,"resource-name","resource-name",2001617100),resource_name),shadow$cljs$devtools$client$env$add_warnings_to_info_$_iter__10966_$_iter__10968(cljs.core.rest(s__10969__$2)));
}
} else {
return null;
}
...
});})(s__10967__$1,map__10972,map__10972__$1,src,resource_name,warnings,xs__6360__auto__,temp__5804__auto__,map__10964,map__10964__$1,msg,info))
,null,null));
});})(s__10967__$1,map__10972,map__10972__$1,src,resource_name,warnings,xs__6360__auto__,temp__5804__auto__,map__10964,map__10964__$1,msg,info))
;
var fs__5520__auto__ = cljs.core.seq(iterys__5519__auto__(warnings));
if(fs__5520__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5520__auto__,shadow$cljs$devtools$client$env$add_warnings_to_info_$_iter__10966(cljs.core.rest(s__10967__$1)));
} else {
var G__11034 = cljs.core.rest(s__10967__$1);
s__10967__$1 = G__11034;
continue;
}
} else {
var G__11035 = cljs.core.rest(s__10967__$1);
s__10967__$1 = G__11035;
continue;
}
} else {
return null;
...
shadow.cljs.devtools.client.env.make_task_fn = (function shadow$cljs$devtools$client$env$make_task_fn(p__10974,p__10975){
var map__10976 = p__10974;
...
shadow.cljs.devtools.client.env.do_js_reload_STAR_ = (function shadow$cljs$devtools$client$env$do_js_reload_STAR_(failure_fn,p__10980){
var vec__10981 = p__10980;
var seq__10982 = cljs.core.seq(vec__10981);
var first__10983 = cljs.core.first(seq__10982);
var seq__10982__$1 = cljs.core.next(seq__10982);
var task = first__10983;
var remaining_tasks = seq__10982__$1;
if(cljs.core.truth_(task)){
try{var G__10985 = (function (){
return (shadow.cljs.devtools.client.env.do_js_reload_STAR_.cljs$core$IFn$_invoke$arity$2 ? shadow.cljs.devtools.client.env.do_js_reload_STAR_.cljs$core$IFn$_invoke$arity$2(failure_fn,remaining_tasks) : shadow.cljs.devtools.client.env.do_js_reload_STAR_.call(null,failure_fn,remaining_tasks));
});
return (task.cljs$core$IFn$_invoke$arity$1 ? task.cljs$core$IFn$_invoke$arity$1(G__10985) : task.call(null,G__10985));
}catch (e10984){var e = e10984;
...
var load_tasks = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.reverse(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__10986_SHARP_){
return shadow.cljs.devtools.client.env.make_task_fn(msg,p1__10986_SHARP_);
}),new cljs.core.Keyword(null,"before-load","before-load",-2060117064).cljs$core$IFn$_invoke$arity$1(reload_info)))),(function (next){
(load_code_fn.cljs$core$IFn$_invoke$arity$0 ? load_code_fn.cljs$core$IFn$_invoke$arity$0() : load_code_fn.call(null));

return (next.cljs$core$IFn$_invoke$arity$0 ? next.cljs$core$IFn$_invoke$arity$0() : next.call(null));
})),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__10987_SHARP_){
return shadow.cljs.devtools.client.env.make_task_fn(msg,p1__10987_SHARP_);
...
var G__11038 = seq__10994;
var G__11039 = chunk__10995;
var G__11040 = count__10996;
var G__11041 = (i__10997 + (1));
seq__10994 = G__11038;
chunk__10995 = G__11039;
count__10996 = G__11040;
i__10997 = G__11041;
continue;
} else {
...
var G__11042 = cljs.core.chunk_rest(seq__10994__$1);
var G__11043 = c__5568__auto__;
var G__11044 = cljs.core.count(c__5568__auto__);
var G__11045 = (0);
seq__10994 = G__11042;
chunk__10995 = G__11043;
count__10996 = G__11044;
i__10997 = G__11045;
continue;
} else {
...
var G__11046 = cljs.core.next(seq__10994__$1);
var G__11047 = null;
var G__11048 = (0);
var G__11049 = (0);
seq__10994 = G__11046;
chunk__10995 = G__11047;
count__10996 = G__11048;
i__10997 = G__11049;
continue;
}
} else {
...
return cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p__11000){
var map__11001 = p__11000;
var map__11001__$1 = cljs.core.__destructure_map(map__11001);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11001__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
return cljs.core.contains_QMARK_(new cljs.core.Keyword(null,"never-load","never-load",1300896819).cljs$core$IFn$_invoke$arity$1(reload_info),ns);
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p__11002){
var map__11003 = p__11002;
var map__11003__$1 = cljs.core.__destructure_map(map__11003);
var rc = map__11003__$1;
var module__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11003__$1,new cljs.core.Keyword(null,"module","module",1424618191));
...
shadow.cljs.devtools.client.env.filter_sources_to_get_full = (function shadow$cljs$devtools$client$env$filter_sources_to_get_full(p__11011,reload_info){
var map__11012 = p__11011;
var map__11012__$1 = cljs.core.__destructure_map(map__11012);
var info = map__11012__$1;
var sources = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11012__$1,new cljs.core.Keyword(null,"sources","sources",-321166424));
var compiled = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11012__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));
var affected = cljs.core.PersistentHashSet.EMPTY;
var sources_to_get = cljs.core.PersistentVector.EMPTY;
var G__11016 = shadow.cljs.devtools.client.env.prefilter_sources(reload_info,sources);
var vec__11017 = G__11016;
...
var src = first__11019;
var more = seq__11018__$1;
var affected__$1 = affected;
var sources_to_get__$1 = sources_to_get;
var G__11016__$1 = G__11016;
while(true){
var affected__$2 = affected__$1;
var sources_to_get__$2 = sources_to_get__$1;
var vec__11025 = G__11016__$1;
...
var src__$1 = first__11027;
var more__$1 = seq__11026__$1;
if(cljs.core.not(src__$1)){
return sources_to_get__$2;
} else {
var map__11028 = src__$1;
var map__11028__$1 = cljs.core.__destructure_map(map__11028);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11028__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var resource_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11028__$1,new cljs.core.Keyword(null,"resource-id","resource-id",-1308422582));
var deps = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11028__$1,new cljs.core.Keyword(null,"deps","deps",1883360319));
var provides = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11028__$1,new cljs.core.Keyword(null,"provides","provides",-1634397992));
...
var G__11052 = affected__$2;
var G__11053 = sources_to_get__$2;
var G__11054 = more__$1;
affected__$1 = G__11052;
sources_to_get__$1 = G__11053;
G__11016__$1 = G__11054;
continue;
} else {
var G__11055 = clojure.set.union.cljs$core$IFn$_invoke$arity$2(affected__$2,provides);
var G__11056 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(sources_to_get__$2,src__$1);
var G__11057 = more__$1;
affected__$1 = G__11055;
sources_to_get__$1 = G__11056;
G__11016__$1 = G__11057;
continue;
}
}
break;
