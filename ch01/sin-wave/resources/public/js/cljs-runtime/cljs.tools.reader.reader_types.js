...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_9754 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_9754(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_9755 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_9755(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_9756 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_9756(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_9757 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_9757(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_9759 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_9759(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_9760 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_9760(reader);
}
});
...
var G__9769 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__9770 = s.append(c);
c = G__9769;
s = G__9770;
continue;
}
