...
var len__4499__auto___22814 = arguments.length;
var i__4500__auto___22815 = (0);
while(true){
if((i__4500__auto___22815 < len__4499__auto___22814)){
args__4502__auto__.push((arguments[i__4500__auto___22815]));

var G__22816 = (i__4500__auto___22815 + (1));
i__4500__auto___22815 = G__22816;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq22811){
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__22817_SHARP_){
return !((cljs.core.meta.call(null,p1__22817_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__22818__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e22822){var _e__21771__auto__ = e22822;
return false;
}})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
}catch (e22824){var _e__21771__auto__ = e22824;
return false;
}}
})())){
...
var _STAR_current_state_STAR_22826 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__22827 = opts;
...
var markup_db = cljs.core.get.call(null,map__22827__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_22826;
}});
...
;
var temp__5455__auto___22831 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___22831)){
var managed_print_level_22832 = temp__5455__auto___22831;
var _STAR_print_level_STAR_22830_22833 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_22832;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_22830_22833,managed_print_level_22832,temp__5455__auto___22831,writer,opts,job_fn){
return (function (p1__22829_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__22829_SHARP_,null);
});})(_STAR_print_level_STAR_22830_22833,managed_print_level_22832,temp__5455__auto___22831,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_22830_22833;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1672621526575
