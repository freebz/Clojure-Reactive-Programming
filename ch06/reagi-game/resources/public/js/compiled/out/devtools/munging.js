...
var o22683 = temp__5455__auto__;
var temp__5455__auto____$1 = (o22683["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o22684 = temp__5455__auto____$1;
return (o22684["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__21764__auto__ = f;
return (o__21764__auto__["toString"]).call(o__21764__auto__);
} else {
return "";
}
}catch (e22685){var _ = e22685;
return "";
}});
...
try{var o__21764__auto___22687 = t;
(o__21764__auto___22687["cljs$lang$ctorPrWriter"]).call(o__21764__auto___22687,t,writer);
}catch (e22686){var __22688 = e22686;
}
...
var char_code = (function (){var o__21764__auto__ = (new String(char$));
return (o__21764__auto__["charCodeAt"]).call(o__21764__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__21764__auto__ = String;
return (o__21764__auto__["fromCharCode"]).call(o__21764__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__22689 = num_code;
switch (G__22689) {
case (1):
return (185);
...
var o__21764__auto__ = String;
return (o__21764__auto__["fromCharCode"]).call(o__21764__auto__,superscript_code);
});
/**
...
}catch (e22691){var _e__21771__auto__ = e22691;
return false;
}})())){
...
var vec__22692 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__22692,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o22695 = temp__5455__auto__;
var temp__5455__auto____$1 = (o22695["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o22696 = temp__5455__auto____$1;
return (o22696["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__22699){
var vec__22700 = p__22699;
var ns_detector = cljs.core.nth.call(null,vec__22700,(0),null);
...
var G__22706 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__22707 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__22706;
remaining_tokens = G__22707;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq22697){
...
var vec__22711 = cljs.core.split_with.call(null,(function (p1__22710_SHARP_){
return cljs.core.not_EQ_.call(null,p1__22710_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__22711,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__22711,(1),null);
...
var vec__22714 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__22714,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__22714,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__22717 = cljs.core.rest.call(null,remaining_tokens);
var G__22718 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__22717;
name_tokens = G__22718;
continue;
} else {
...
var vec__22721 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__22721,(0),null);
var arity = cljs.core.nth.call(null,vec__22721,(1),null);
var vec__22724 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__22724,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__22724,(1),null);
var vec__22727 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__22727,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__22727,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__22727,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__22727,(3),null);
...
var vec__22733 = result;
var munged_ns = cljs.core.nth.call(null,vec__22733,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__22733,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__22733,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__22733,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__22733,(4),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__22737 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__22737,(0),null);
var args = cljs.core.nth.call(null,vec__22737,(1),null);
var vec__22740 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__22740,(0),null);
var name = cljs.core.nth.call(null,vec__22740,(1),null);
...
var G__22743 = (arity + (1));
var G__22744 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__22745){
var vec__22746 = p__22745;
var arity = cljs.core.nth.call(null,vec__22746,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__22746,(1),null);
...
return cljs.core.get.call(null,arities,p1__22749_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__22750_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__22753){
var vec__22754 = p__22753;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__22754,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq22751){
var G__22752 = cljs.core.first.call(null,seq22751);
var seq22751__$1 = cljs.core.next.call(null,seq22751);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22752,seq22751__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__22762__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__22762__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__22762__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__22762__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__22763 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__22763,(0),null);
var fn_name = cljs.core.nth.call(null,vec__22763,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__22763,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__22763,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__22763,(4),null);
var arity = cljs.core.nth.call(null,vec__22763,(5),null);
...
var o__21764__auto__ = f;
return (o__21764__auto__["getBasis"]).call(o__21764__auto__);
});
/**
...
}catch (e22767){var _e__21771__auto__ = e22767;
...
var G__22768 = (obj[cljs.core.first.call(null,path)]);
var G__22769 = cljs.core.rest.call(null,path);
obj = G__22768;
path = G__22769;
continue;
} else {
...
return (function (accum,p__22770){
var vec__22771 = p__22770;
var bit = cljs.core.nth.call(null,vec__22771,(0),null);
var protocol = cljs.core.nth.call(null,vec__22771,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__22774){
var vec__22775 = p__22774;
var ns = cljs.core.nth.call(null,vec__22775,(0),null);
var name = cljs.core.nth.call(null,vec__22775,(1),null);
var selector = cljs.core.nth.call(null,vec__22775,(2),null);
...
return (function (p__22779){
var vec__22780 = p__22779;
var munged_name = cljs.core.nth.call(null,vec__22780,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__22780,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__22780,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__22778_SHARP_){
return (obj[cljs.core.first.call(null,p1__22778_SHARP_)]);
});})(name,sorted_matches,vec__22780,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1672621526303
