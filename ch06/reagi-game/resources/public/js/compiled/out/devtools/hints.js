...
}catch (e25071){var _e = e25071;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___25074 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___25074)){
var seen_errors_25075 = temp__5455__auto___25074;
if(cljs.core.truth_(seen_errors_25075.has(self))){
} else {
seen_errors_25075.add(self);

var temp__5457__auto___25076 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___25076)){
var sense_25077 = temp__5457__auto___25076;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_25077)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1672621531945
