...
return (new CustomEvent(event_name,(function (){var obj28502 = {"detail":data};
return obj28502;
})()));
} else {
...
var f = (function (){var pred__28509 = cljs.core._EQ_;
var expr__28510 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__28509.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__28510))){
return ((function (pred__28509,expr__28510){
return (function (p1__28503_SHARP_){
return console.warn(p1__28503_SHARP_);
});
;})(pred__28509,expr__28510))
} else {
if(cljs.core.truth_(pred__28509.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__28510))){
return ((function (pred__28509,expr__28510){
return (function (p1__28504_SHARP_){
return console.debug(p1__28504_SHARP_);
});
;})(pred__28509,expr__28510))
} else {
if(cljs.core.truth_(pred__28509.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__28510))){
return ((function (pred__28509,expr__28510){
return (function (p1__28505_SHARP_){
return console.error(p1__28505_SHARP_);
});
;})(pred__28509,expr__28510))
} else {
return ((function (pred__28509,expr__28510){
return (function (p1__28506_SHARP_){
return console.log(p1__28506_SHARP_);
});
;})(pred__28509,expr__28510))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__28513){
...
var eval_fn = cljs.core.get.call(null,map__28514__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__28516_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__28518,(0),null);
var v = cljs.core.nth.call(null,vec__28518,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1672621534711
