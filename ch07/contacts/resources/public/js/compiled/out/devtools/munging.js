...
var o27215 = temp__5455__auto__;
var temp__5455__auto____$1 = (o27215["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o27216 = temp__5455__auto____$1;
return (o27216["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__26327__auto__ = f;
return (o__26327__auto__["toString"]).call(o__26327__auto__);
} else {
return "";
}
}catch (e27217){var _ = e27217;
return "";
}});
...
try{var o__26327__auto___27219 = t;
(o__26327__auto___27219["cljs$lang$ctorPrWriter"]).call(o__26327__auto___27219,t,writer);
}catch (e27218){var __27220 = e27218;
}
...
var char_code = (function (){var o__26327__auto__ = (new String(char$));
return (o__26327__auto__["charCodeAt"]).call(o__26327__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__26327__auto__ = String;
return (o__26327__auto__["fromCharCode"]).call(o__26327__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__27221 = num_code;
switch (G__27221) {
case (1):
return (185);
...
var o__26327__auto__ = String;
return (o__26327__auto__["fromCharCode"]).call(o__26327__auto__,superscript_code);
});
/**
...
}catch (e27223){var _e__26334__auto__ = e27223;
return false;
}})())){
...
var vec__27224 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__27224,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o27227 = temp__5455__auto__;
var temp__5455__auto____$1 = (o27227["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o27228 = temp__5455__auto____$1;
return (o27228["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4499__auto___27235 = arguments.length;
var i__4500__auto___27236 = (0);
while(true){
if((i__4500__auto___27236 < len__4499__auto___27235)){
args__4502__auto__.push((arguments[i__4500__auto___27236]));

var G__27237 = (i__4500__auto___27236 + (1));
i__4500__auto___27236 = G__27237;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__27231){
var vec__27232 = p__27231;
var ns_detector = cljs.core.nth.call(null,vec__27232,(0),null);
...
var G__27238 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__27239 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__27238;
remaining_tokens = G__27239;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq27229){
...
var vec__27243 = cljs.core.split_with.call(null,(function (p1__27242_SHARP_){
return cljs.core.not_EQ_.call(null,p1__27242_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__27243,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__27243,(1),null);
...
var vec__27246 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__27246,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__27246,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__27249 = cljs.core.rest.call(null,remaining_tokens);
var G__27250 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__27249;
name_tokens = G__27250;
continue;
} else {
...
var vec__27253 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__27253,(0),null);
var arity = cljs.core.nth.call(null,vec__27253,(1),null);
var vec__27256 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__27256,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__27256,(1),null);
var vec__27259 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__27259,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__27259,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__27259,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__27259,(3),null);
...
var vec__27265 = result;
var munged_ns = cljs.core.nth.call(null,vec__27265,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__27265,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__27265,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__27265,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__27265,(4),null);
var arity = cljs.core.nth.call(null,vec__27265,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__27269 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__27269,(0),null);
var args = cljs.core.nth.call(null,vec__27269,(1),null);
var vec__27272 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__27272,(0),null);
var name = cljs.core.nth.call(null,vec__27272,(1),null);
...
var G__27275 = (arity + (1));
var G__27276 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__27277){
var vec__27278 = p__27277;
var arity = cljs.core.nth.call(null,vec__27278,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__27278,(1),null);
...
return cljs.core.get.call(null,arities,p1__27281_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__27282_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27285){
var vec__27286 = p__27285;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__27286,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27283){
var G__27284 = cljs.core.first.call(null,seq27283);
var seq27283__$1 = cljs.core.next.call(null,seq27283);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27284,seq27283__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__27294__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__27294__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__27294__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__27294__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27295 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__27295,(0),null);
var fn_name = cljs.core.nth.call(null,vec__27295,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__27295,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__27295,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__27295,(4),null);
var arity = cljs.core.nth.call(null,vec__27295,(5),null);
...
var o__26327__auto__ = f;
return (o__26327__auto__["getBasis"]).call(o__26327__auto__);
});
/**
...
}catch (e27299){var _e__26334__auto__ = e27299;
...
var G__27300 = (obj[cljs.core.first.call(null,path)]);
var G__27301 = cljs.core.rest.call(null,path);
obj = G__27300;
path = G__27301;
continue;
} else {
...
return (function (accum,p__27302){
var vec__27303 = p__27302;
var bit = cljs.core.nth.call(null,vec__27303,(0),null);
var protocol = cljs.core.nth.call(null,vec__27303,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27306){
var vec__27307 = p__27306;
var ns = cljs.core.nth.call(null,vec__27307,(0),null);
var name = cljs.core.nth.call(null,vec__27307,(1),null);
var selector = cljs.core.nth.call(null,vec__27307,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__27312,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__27312,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__27312,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__27310_SHARP_){
return (obj[cljs.core.first.call(null,p1__27310_SHARP_)]);
});})(name,sorted_matches,vec__27312,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1673416709519
