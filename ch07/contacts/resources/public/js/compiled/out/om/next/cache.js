...
var self__ = this;
var this$ = this;
var x_SINGLEQUOTE__21734 = cljs.core.vary_meta.call(null,x,cljs.core.assoc,new cljs.core.Keyword(null,"client-time","client-time",-1212214195),(new Date()));
if((self__.size <= self__.arr.length)){
var id_SINGLEQUOTE__21735 = self__.arr.shift();
cljs.core.swap_BANG_.call(null,self__.index,((function (id_SINGLEQUOTE__21735,x_SINGLEQUOTE__21734,this$){
return (function (p1__21733_SHARP_){
return cljs.core.assoc.call(null,cljs.core.dissoc.call(null,p1__21733_SHARP_,id_SINGLEQUOTE__21735),id,x_SINGLEQUOTE__21734);
});})(id_SINGLEQUOTE__21735,x_SINGLEQUOTE__21734,this$))
);
} else {
cljs.core.swap_BANG_.call(null,self__.index,cljs.core.assoc,id,x_SINGLEQUOTE__21734);
}
...
om.next.cache.Cache.cljs$lang$ctorPrWriter = (function (this__4161__auto__,writer__4162__auto__,opt__4163__auto__){
return cljs.core._write.call(null,writer__4162__auto__,"om.next.cache/Cache");
});
...
//# sourceMappingURL=cache.js.map?rel=1673416699693
