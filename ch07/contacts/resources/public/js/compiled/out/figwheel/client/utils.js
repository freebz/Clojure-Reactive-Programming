...
return (new CustomEvent(event_name,(function (){var obj32560 = {"detail":data};
return obj32560;
})()));
} else {
...
var expr__32568 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
...
return console.warn(p1__32561_SHARP_);
});
...
return console.debug(p1__32562_SHARP_);
});
;})(pred__32567,expr__32568))
} else {
...
return console.error(p1__32563_SHARP_);
});
;})(pred__32567,expr__32568))
} else {
return ((function (pred__32567,expr__32568){
return (function (p1__32564_SHARP_){
return console.log(p1__32564_SHARP_);
});
;})(pred__32567,expr__32568))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__32571){
...
var opts = map__32572__$1;
var eval_fn = cljs.core.get.call(null,map__32572__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__32574_SHARP_);
});})(new_def))
);
...
return (function (p__32575){
var vec__32576 = p__32575;
var ky = cljs.core.nth.call(null,vec__32576,(0),null);
var v = cljs.core.nth.call(null,vec__32576,(1),null);
...
}catch (e32581){if((e32581 instanceof Error)){
var e = e32581;
return not_found;
} else {
throw e32581;
...
//# sourceMappingURL=utils.js.map?rel=1673416717325
