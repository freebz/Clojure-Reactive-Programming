...
var file = cljs.core.get.call(null,map__13706__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__13706__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__13706__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e13705){var _e = e13705;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___13708 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___13708)){
var seen_errors_13709 = temp__5455__auto___13708;
if(cljs.core.truth_(seen_errors_13709.has(self))){
} else {
seen_errors_13709.add(self);

var temp__5457__auto___13710 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___13710)){
var sense_13711 = temp__5457__auto___13710;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_13711)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1673484820667
