...
var o11773 = temp__5455__auto__;
var temp__5455__auto____$1 = (o11773["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o11774 = temp__5455__auto____$1;
return (o11774["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__10885__auto__ = f;
return (o__10885__auto__["toString"]).call(o__10885__auto__);
} else {
return "";
}
}catch (e11775){var _ = e11775;
return "";
}});
...
try{var o__10885__auto___11777 = t;
(o__10885__auto___11777["cljs$lang$ctorPrWriter"]).call(o__10885__auto___11777,t,writer);
}catch (e11776){var __11778 = e11776;
}
...
var char_code = (function (){var o__10885__auto__ = (new String(char$));
return (o__10885__auto__["charCodeAt"]).call(o__10885__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__10885__auto__ = String;
return (o__10885__auto__["fromCharCode"]).call(o__10885__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__11779 = num_code;
switch (G__11779) {
case (1):
return (185);
...
var o__10885__auto__ = String;
return (o__10885__auto__["fromCharCode"]).call(o__10885__auto__,superscript_code);
});
/**
...
}catch (e11781){var _e__10892__auto__ = e11781;
return false;
}})())){
...
var vec__11782 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__11782,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o11785 = temp__5455__auto__;
var temp__5455__auto____$1 = (o11785["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o11786 = temp__5455__auto____$1;
return (o11786["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4499__auto___11793 = arguments.length;
var i__4500__auto___11794 = (0);
while(true){
if((i__4500__auto___11794 < len__4499__auto___11793)){
args__4502__auto__.push((arguments[i__4500__auto___11794]));

var G__11795 = (i__4500__auto___11794 + (1));
i__4500__auto___11794 = G__11795;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__11789){
var vec__11790 = p__11789;
var ns_detector = cljs.core.nth.call(null,vec__11790,(0),null);
...
var G__11796 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__11797 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__11796;
remaining_tokens = G__11797;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq11787){
var G__11788 = cljs.core.first.call(null,seq11787);
var seq11787__$1 = cljs.core.next.call(null,seq11787);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11788,seq11787__$1);
});
...
var vec__11801 = cljs.core.split_with.call(null,(function (p1__11800_SHARP_){
return cljs.core.not_EQ_.call(null,p1__11800_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__11801,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__11801,(1),null);
...
var vec__11804 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__11804,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__11804,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__11807 = cljs.core.rest.call(null,remaining_tokens);
var G__11808 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__11807;
name_tokens = G__11808;
continue;
} else {
...
var vec__11811 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__11811,(0),null);
var arity = cljs.core.nth.call(null,vec__11811,(1),null);
var vec__11814 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__11814,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__11814,(1),null);
var vec__11817 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__11817,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__11817,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__11817,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__11817,(3),null);
...
var vec__11823 = result;
var munged_ns = cljs.core.nth.call(null,vec__11823,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__11823,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__11823,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__11823,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__11823,(4),null);
var arity = cljs.core.nth.call(null,vec__11823,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__11827 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__11827,(0),null);
var args = cljs.core.nth.call(null,vec__11827,(1),null);
var vec__11830 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__11830,(0),null);
var name = cljs.core.nth.call(null,vec__11830,(1),null);
...
var G__11833 = (arity + (1));
var G__11834 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__11835){
var vec__11836 = p__11835;
var arity = cljs.core.nth.call(null,vec__11836,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__11836,(1),null);
...
return cljs.core.get.call(null,arities,p1__11839_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__11840_SHARP_);
...
var args__4502__auto__ = [];
var len__4499__auto___11847 = arguments.length;
var i__4500__auto___11848 = (0);
while(true){
if((i__4500__auto___11848 < len__4499__auto___11847)){
args__4502__auto__.push((arguments[i__4500__auto___11848]));

var G__11849 = (i__4500__auto___11848 + (1));
i__4500__auto___11848 = G__11849;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__11843){
var vec__11844 = p__11843;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__11844,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq11841){
var G__11842 = cljs.core.first.call(null,seq11841);
var seq11841__$1 = cljs.core.next.call(null,seq11841);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11842,seq11841__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__11852__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__11852__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__11852__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__11852__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__11853 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__11853,(0),null);
var fn_name = cljs.core.nth.call(null,vec__11853,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__11853,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__11853,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__11853,(4),null);
var arity = cljs.core.nth.call(null,vec__11853,(5),null);
...
var o__10885__auto__ = f;
return (o__10885__auto__["getBasis"]).call(o__10885__auto__);
});
/**
...
}catch (e11857){var _e__10892__auto__ = e11857;
...
var G__11858 = (obj[cljs.core.first.call(null,path)]);
var G__11859 = cljs.core.rest.call(null,path);
obj = G__11858;
path = G__11859;
continue;
} else {
...
return (function (accum,p__11860){
var vec__11861 = p__11860;
var bit = cljs.core.nth.call(null,vec__11861,(0),null);
var protocol = cljs.core.nth.call(null,vec__11861,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__11864){
var vec__11865 = p__11864;
var ns = cljs.core.nth.call(null,vec__11865,(0),null);
var name = cljs.core.nth.call(null,vec__11865,(1),null);
var selector = cljs.core.nth.call(null,vec__11865,(2),null);
...
return (function (p__11869){
var vec__11870 = p__11869;
var munged_name = cljs.core.nth.call(null,vec__11870,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__11870,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__11870,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__11868_SHARP_){
return (obj[cljs.core.first.call(null,p1__11868_SHARP_)]);
});})(name,sorted_matches,vec__11870,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1673484816763
