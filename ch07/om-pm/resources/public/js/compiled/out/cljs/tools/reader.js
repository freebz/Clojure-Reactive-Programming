...
var G__1553 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__1553;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__1554 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__1554,ch);
...
if(("\\" === ch__$1)){
var ch_1555__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_1555__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_1555__$2);
} else {
}

var G__1556 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__1556;
continue;
}
}
...
var vec__1564 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__1564,(0),null);
var start_column = cljs.core.nth.call(null,vec__1564,(1),null);
...
var G__1567 = cljs.core.conj_BANG_.call(null,a,form);
a = G__1567;
continue;
}
}
...
var _STAR_read_delim_STAR_1568 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_1568;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__1569 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__1569,(0),null);
var start_column = cljs.core.nth.call(null,vec__1569,(1),null);
...
var vec__1572 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__1572,(0),null);
var end_column = cljs.core.nth.call(null,vec__1572,(1),null);
...
var start_line = cljs.core.nth.call(null,vec__1575,(0),null);
var start_column = cljs.core.nth.call(null,vec__1575,(1),null);
...
var vec__1578 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__1578,(0),null);
var end_column = cljs.core.nth.call(null,vec__1578,(1),null);
...
var vec__1581 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__1581,(0),null);
var start_column = cljs.core.nth.call(null,vec__1581,(1),null);
...
var vec__1584 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__1584,(0),null);
var end_column = cljs.core.nth.call(null,vec__1584,(1),null);
...
switch (G__1593) {
case "\\":
var G__1597 = (function (){var G__1594 = sb;
G__1594.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__1594;
})();
var G__1598 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__1597;
ch = G__1598;
continue;
...
break;
default:
var G__1599 = (function (){var G__1595 = sb;
G__1595.append(ch);

return G__1595;
})();
var G__1600 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__1599;
ch = G__1600;
continue;
...
var vec__1601 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__1601,(0),null);
var end_column = cljs.core.nth.call(null,vec__1601,(1),null);
...
var vec__1604 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__1604,(0),null);
var column = cljs.core.nth.call(null,vec__1604,(1),null);
...
var vec__1609 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__1609,(0),null);
var column = cljs.core.nth.call(null,vec__1609,(1),null);
...
var vec__1614 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__1614,(0),null);
var column = cljs.core.nth.call(null,vec__1614,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var G__1625 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__1625,true,null,opts,pending_forms);
...
var G__1626 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__1626)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__1626)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__1626)){
...
var _STAR_suppress_read_STAR_1627 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_1627;
}});
...
var G__1628 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__1628,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__1628,rdr,first_line);
...
var G__1632 = matched;
var G__1633 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__1632;
finished = G__1633;
continue;
} else {
...
var _STAR_suppress_read_STAR_1634 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_1634;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env1635 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__1636 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__1636,"(");
...
var G__1637 = (i + (1));
var G__1638 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3922__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env1635;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__1639 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__1639);
...
var G__1640 = cljs.core.next.call(null,s__$1);
var G__1641 = ret;
s__$1 = G__1640;
r = G__1641;
continue;
...
var G__1642 = cljs.core.next.call(null,s);
var G__1643 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__1642;
key_vals = G__1643;
continue;
} else {
...
var gensym_env1647 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env1647;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__1648 = token;
var G__1648__$1 = (((G__1648 == null))?null:cljs.core.subs.call(null,G__1648,(1)));
var G__1648__$2 = (((G__1648__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__1648__$1));
var G__1648__$3 = (((G__1648__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__1648__$2));
var G__1648__$4 = (((G__1648__$3 == null))?null:cljs.core.symbol.call(null,G__1648__$3));
if((G__1648__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__1648__$4);
}
})():(function (){var G__1649 = token;
var G__1649__$1 = (((G__1649 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__1649));
if((G__1649__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__1649__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
}catch (e1656){if((e1656 instanceof Error)){
var e = e1656;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__1660,reader){
...
var opts = map__1661__$1;
var eof = cljs.core.get.call(null,map__1661__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4499__auto___1669 = arguments.length;
var i__4500__auto___1670 = (0);
while(true){
if((i__4500__auto___1670 < len__4499__auto___1669)){
args__4502__auto__.push((arguments[i__4500__auto___1670]));

var G__1671 = (i__4500__auto___1670 + (1));
i__4500__auto___1670 = G__1671;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq1667){
var G__1668 = cljs.core.first.call(null,seq1667);
var seq1667__$1 = cljs.core.next.call(null,seq1667);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__1668,seq1667__$1);
});


//# sourceMappingURL=reader.js.map?rel=1673484805391
