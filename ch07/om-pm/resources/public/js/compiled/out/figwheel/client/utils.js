...
return (new CustomEvent(event_name,(function (){var obj21902 = {"detail":data};
return obj21902;
})()));
} else {
...
var f = (function (){var pred__21909 = cljs.core._EQ_;
var expr__21910 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__21909.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__21910))){
return ((function (pred__21909,expr__21910){
return (function (p1__21903_SHARP_){
return console.warn(p1__21903_SHARP_);
});
;})(pred__21909,expr__21910))
} else {
if(cljs.core.truth_(pred__21909.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__21910))){
return ((function (pred__21909,expr__21910){
...
if(cljs.core.truth_(pred__21909.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__21910))){
return ((function (pred__21909,expr__21910){
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__21913){
...
var opts = map__21914__$1;
var eval_fn = cljs.core.get.call(null,map__21914__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__21916_SHARP_);
});})(new_def))
);
...
return (function (p__21917){
var vec__21918 = p__21917;
var ky = cljs.core.nth.call(null,vec__21918,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1673484851788
